...
{
    /// <summary>
    /// Phone application page for EditorialFeed_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class EditorialFeed_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for EditorialFeed_Detail and all its components.
        /// </summary>
        public EditorialFeed_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaEditorialFeed_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaEditorialFeed_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaEditorialFeed_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaEditorialFeed_Detail(PanoramaEditorialFeed_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaEditorialFeed_Detail(PanoramaItem panoramaItem)        
        {
