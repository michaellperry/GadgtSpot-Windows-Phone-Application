...
{
    /// <summary>
    /// Phone application page for Main_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Main_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Main_Detail and all its components.
        /// </summary>
        public Main_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaMain_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaMain_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaMain_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaMain_Detail(PanoramaMain_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaMain_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IMain_mainrssfeed>();
				AddHomeAppBarButton();
				...
				((IViewModels.IMain_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
