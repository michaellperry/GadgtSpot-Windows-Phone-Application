...
{
    /// <summary>
    /// Phone application page for GiveawaysFeed_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class GiveawaysFeed_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for GiveawaysFeed_Detail and all its components.
        /// </summary>
        public GiveawaysFeed_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaGiveawaysFeed_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaGiveawaysFeed_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaGiveawaysFeed_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaGiveawaysFeed_Detail(PanoramaGiveawaysFeed_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaGiveawaysFeed_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IGiveawaysFeed_GiveawaysFeed>();
				AddHomeAppBarButton();
				...
				((IViewModels.IGiveawaysFeed_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
