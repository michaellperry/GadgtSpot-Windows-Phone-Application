...
namespace WPAppStudio.ViewModel
{
    ...
    {       
		...
		private readonly Repositories.Videos_Videos _videos_Videos;
        ...
        public async void NextpanoramaVideos_DetailVideos0Delegate() 
        {
			...
			var next = await  _videos_Videos.Next(CurrentYouTubeVideo);
        ...
        {
			var prev =  _videos_Videos.Previous(CurrentYouTubeVideo);
        ...
        {
            HasPreviouspanoramaVideos_DetailVideos0 = _videos_Videos.HasPrevious(CurrentYouTubeVideo);
			HasNextpanoramaVideos_DetailVideos0 = await _videos_Videos.HasNext(CurrentYouTubeVideo);
