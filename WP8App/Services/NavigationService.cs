...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.IMain_NewsViewModel), "/View/Main_News.xaml" },
            { typeof(IViewModels.IVideos_DetailVideosViewModel), "/View/Videos_DetailVideos.xaml" },
            { typeof(IViewModels.IEditorialFeed_DetailViewModel), "/View/EditorialFeed_Detail.xaml" },
            { typeof(IViewModels.IGiveawaysFeed_DetailViewModel), "/View/GiveawaysFeed_Detail.xaml" },
            { typeof(IViewModels.IReviewsFeed_DetailViewModel), "/View/ReviewsFeed_Detail.xaml" },
            { typeof(IViewModels.INewsFeed_DetailViewModel), "/View/NewsFeed_Detail.xaml" },
            { typeof(IViewModels.IMain_DetailViewModel), "/View/Main_Detail.xaml" },
