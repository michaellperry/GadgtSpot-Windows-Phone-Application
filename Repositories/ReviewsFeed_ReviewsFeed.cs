...
namespace WPAppStudio.Repositories
{
    ...
    public class ReviewsFeed_ReviewsFeed : IReviewsFeed_ReviewsFeed 
    {
		...
		private const string RssUrl = "http://gadgtspot.com/category/review/feed";

        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewsFeed_ReviewsFeed" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public ReviewsFeed_ReviewsFeed(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://gadgtspot.com/category/review/feed), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("ReviewsFeed_ReviewsFeed", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("ReviewsFeed_ReviewsFeed");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://gadgtspot.com/category/review/feed), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
