...
namespace WPAppStudio.Repositories
{
    ...
    public class Videos_Videos : IVideos_Videos 
    {
		...
		private const string YoutubeQuery = @"gadgtspot";

        /// <summary>
        /// Initializes a new instance of the <see cref="Videos_Videos" /> class.
        /// </summary>
        /// <param name="youtubeDataSource">A Youtube data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Videos_Videos(RepositoriesBase.IYoutubeDataSource youtubeDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from Youtube (channel: gadgtspot ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (channel: gadgtspot ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
        ...
        {
			var data = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Videos_Videos");
        ...
        {
			var storedItems = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Videos_Videos");
            ...
            if (_internetService.IsNetworkAvailable() && (pageNotSaved || forceRecaching))
            {
                ...
                if(newItems != null && newItems.Any())
				{
					...
					_storageService.Save("Videos_Videos", new ObservableCollection<EntitiesBase.YouTubeVideo>(storedCollection));
				}
			}
