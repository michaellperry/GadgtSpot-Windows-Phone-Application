...
namespace WPAppStudio.Repositories
{
    ...
    public class EditorialFeed_EditorialFeed : IEditorialFeed_EditorialFeed 
    {
		...
		private const string RssUrl = "http://gadgtspot.com/category/editorial/feed";

        /// <summary>
        /// Initializes a new instance of the <see cref="EditorialFeed_EditorialFeed" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public EditorialFeed_EditorialFeed(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://gadgtspot.com/category/editorial/feed), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("EditorialFeed_EditorialFeed", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("EditorialFeed_EditorialFeed");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://gadgtspot.com/category/editorial/feed), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
