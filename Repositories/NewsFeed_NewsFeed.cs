...
namespace WPAppStudio.Repositories
{
    ...
    public class NewsFeed_NewsFeed : INewsFeed_NewsFeed 
    {
		...
		private const string RssUrl = "http://gadgtspot.com/category/news/feed";

        /// <summary>
        /// Initializes a new instance of the <see cref="NewsFeed_NewsFeed" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public NewsFeed_NewsFeed(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://gadgtspot.com/category/news/feed), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("NewsFeed_NewsFeed", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("NewsFeed_NewsFeed");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://gadgtspot.com/category/news/feed), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
