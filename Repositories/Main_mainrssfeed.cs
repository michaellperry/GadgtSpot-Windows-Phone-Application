...
namespace WPAppStudio.Repositories
{
    ...
    public class Main_mainrssfeed : IMain_mainrssfeed 
    {
		...
		private const string RssUrl = "http://gadgtspot.com/feed";

        /// <summary>
        /// Initializes a new instance of the <see cref="Main_mainrssfeed" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Main_mainrssfeed(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://gadgtspot.com/feed), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("Main_mainrssfeed", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("Main_mainrssfeed");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://gadgtspot.com/feed), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
